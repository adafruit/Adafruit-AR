...
class QRViewController: UIViewController, ARSCNViewDelegate {
    ...
    var tempButton = SCNNode()
    var tempInfo = SCNNode()
...
//                neoPixelButton = cpxNode.childNode(withName: "neopixel Button", recursively: true)!
//                
//                neoPixelInfo = cpxNode.childNode(withName: "neopixel Info", recursively: true)!
//                
//             //   neoPixelInfo.isHidden = true
                ...
                //NeoPixels
                neoPixelButton = cpxNode.childNode(withName: "neopixel_Button", recursively: true)!
                
                neoPixelInfo = cpxNode.childNode(withName: "neopixel_Info", recursively: true)!
                
                neoPixelInfo.isHidden = true
               
                //ATSAMD21
                ATSButton = cpxNode.childNode(withName: "ATSAMD21_Micro_button", recursively: true)!
                
                ATSInfo = cpxNode.childNode(withName: "ATSAMD_info", recursively: true)!
                ...
                crocButton = cpxNode.childNode(withName: "Croc_Button", recursively: true)!
                
                crocInfo = cpxNode.childNode(withName: "Croc_info", recursively: true)!
                ...
                //Temperature Sensor
                tempButton = cpxNode.childNode(withName: "temp_button", recursively: true)!
                
                tempInfo = cpxNode.childNode(withName: "temp_info", recursively: true)!
                
                
                tempInfo.isHidden = true
                
                //Speaker
                speakButton = cpxNode.childNode(withName: "speaker_button", recursively: true)!
                
                speakInfo = cpxNode.childNode(withName: "speaker_info", recursively: true)!
                
                speakInfo.isHidden = true
                
                //Mic
                micButton = cpxNode.childNode(withName: "mic_button", recursively: true)!
                
                micInfo = cpxNode.childNode(withName: "mic_info", recursively: true)!
...
//                micInfo.constraints = [billboardConstraint]
