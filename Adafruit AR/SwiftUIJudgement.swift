...
@available(iOS 13.0, *)
struct SwiftUIJudgement: View {

    @State var displayText = ""

    var text = ["Ah! Looks like you have a tarot card!","Hmmm...This is card of Judgement!","If the spectrum is crowded, move to another!", "If you find yourself at a crossroads, trust your judgement and know that you’re on the right path.","That was fun! Do you have another?"]
